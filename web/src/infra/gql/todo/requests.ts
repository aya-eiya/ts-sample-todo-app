...
export function getSdk(
  ...
  return {
    readAll(
      variables?: ReadAllQueryVariables,
      requestHeaders?: HeadersInit
    ): Promise<ReadAllQuery> {
      return withWrapper(() =>
        client.request<ReadAllQuery>(
          print(ReadAllDocument),
          variables,
          requestHeaders
        )
      )
    ...
    remove(
      ...
      return withWrapper(() =>
        client.request<RemoveMutation>(
          print(RemoveDocument),
          variables,
          requestHeaders
        )
      )
